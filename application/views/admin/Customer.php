        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response === "Success.") {
                        // If the response indicates success, show success message and redirect
                        Swal.fire({
                            icon: 'success',
                            title: 'Deleted!',
                            ...
                            // After the SweetAlert is closed, redirect to the desired page
                            window.location.href = 'customer.php';
                        });
                    } else {
                        ...
                        Swal.fire({
                            icon: 'error',
                            title: 'Error!',
                            text: 'Cannot delete the item. It is connected to another table.',
                        });
                    }
                },
                error: function(xhr, status, error) {
